/*
  Token class used to represent output tokens generated by the scanner.
  Each token includes a type, optional value, and source position.
*/

class Token {

  // Unused but kept from starter code
  ...
  //Token types used for SGML document scanning.
  
  public final static int WORD = 22;
  public final static int NUMBER = 23;
  public final static int APOSTROPHIZED = 24;
  public final static int HYPHENATED = 25;
  ...
  Token (int type, String value, int line, int column) {
    ...
    m_line = line;
    m_column = column;
  } //Constructs a token with a given type, value, and source position.

  /*
    Returns a string representation of the token in the format
    required by the assignment output specification.
  */
